...
import { usePrintSteeringCommitteeProcedures } from "@/services/api-sdk/models/steering-committee";
...
export default function PrintProceduresButton({
  ...
  const form = useForm();
  const { mutateAsync } = usePrintSteeringCommitteeProcedures(meetingId);
