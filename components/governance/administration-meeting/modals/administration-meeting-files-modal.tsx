...
import AddFilesButton from "@/components/governance/administration-meeting/buttons/add-files-button";
...
export default function AdministrationMeetingFilesModal({
  meetingId,
  meetingTitle,
  ...props
}) {
