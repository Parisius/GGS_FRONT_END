...
import AddTaskDialog from "@/components/governance/steering-committee/modals/add-task-dialog";
import GeneralMeetingTimeline from "@/components/governance/steering-committee/ui/steering-committee-timeline";
export default function SteeringCommitteeTimelineModal({
  meetingId,
  meetingDate,
  meetingTitle,
  ...props
