...
import { usePrintSteeringCommittee } from "@/services/api-sdk/models/steering-committee";
export default function PrintSteeringCommitteeButton({
  meetingId,
  className,
  ...props
}) {
  const form = useForm();
  const { mutateAsync } = usePrintSteeringCommittee(meetingId);
