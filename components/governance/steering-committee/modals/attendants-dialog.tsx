...
import AttendantsTable from "@/components/governance/steering-committee/tables/attendants-table";
import PrintAttendantsListButton from "@/components/governance/steering-committee/buttons/print-attendants-list-button";
