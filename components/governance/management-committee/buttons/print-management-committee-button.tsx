...
import { usePrintManagementCommittee } from "@/services/api-sdk/models/management-committee";
export default function PrintManagementCommitteeButton({
  meetingId,
  className,
  ...props
}) {
  const form = useForm();
  const { mutateAsync } = usePrintManagementCommittee(meetingId);
