...
import { ContractRoutes, PersonalSafetyRoutes } from "@/config/routes";
import { Button } from "@/components/ui/button";
import { MoveRight } from "lucide-react";
import { getStatusLabel } from "@/lib/safety/utils";

export default function PersonalSafetyCard({
  personalSafetyId,
  title,
  reference,
  type,
      ...
      <CardHeader>
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          >
            <Link
              href={
                PersonalSafetyRoutes.personalSafetyPage(personalSafetyId).index
              }
            >
