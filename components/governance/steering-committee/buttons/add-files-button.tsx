...
import { useAddSteeringCommitteeFile } from "@/services/api-sdk/models/steering-committee";
import { toast } from "@/components/ui/use-toast";
import { useForm } from "react-hook-form";
import EllipsisLoader from "@/components/ui/ellipsis-loader";
export default function AddFilesButton({ meetingId, className }) {
  const form = useForm();
  const { mutateAsync } = useAddSteeringCommitteeFile(meetingId);
    ...
    <DropdownMenu>
      ...
      <DropdownMenuContent>
        {fileTypes.map(({ value, label }) => (
          ...
          >
            <label
              htmlFor="steering-committee-file-input"
      ...
      <input
        ...
        className="sr-only"
        id="steering-committee-file-input"
