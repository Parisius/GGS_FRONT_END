 ...
 */
export const getArchivedSteeringCommittees = async () => {
  ...
  if (response.ok) {
    ...
    return data.data
      ...
      .filter((SteeringCommittee) => SteeringCommittee !== null);
  }
 ...
 * @throws {ApiError} if the request fails.
 */
export const getCurrentSteeringCommittee = async () => {
  const response = await fetchService.get(
 ...
 * @throws {ApiError} if the request fails.
 */
export const getOneSteeringCommittee = async (meetingId) => {
  const response = await fetchService.get(
 ...
 */
export const createSteeringCommittee = async (args) => {
 ...
 * @throws {ApiError} if the request fails.
 */
export const updateSteeringCommittee = async (meetingId, args) => {
...
export const addSteeringCommitteeFile = async (meetingId, args) => {
 ...
 * @throws {ApiError} if the request fails.
 */
export const printSteeringCommittee = async (meetingId) => {
  const response = await fetchService.get(
 ...
 * @throws {ApiError} if the request fails.
 */
export const printSteeringCommitteeChecklist = async (meetingId) => {
  const response = await fetchService.get(
 ...
 * @throws {ApiError} if the request fails.
 */
export const printSteeringCommitteeProcedures = async (meetingId) => {
  const response = await fetchService.get(
