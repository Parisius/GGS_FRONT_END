...
import { usePrintPersonalSafety } from "@/services/api-sdk/models/personal-safety";
export default function PrintPersonalSafetyButton({
  personalSafetyId,
  className,
  ...props
}) {
  const form = useForm();
  const { mutateAsync } = usePrintPersonalSafety(personalSafetyId);
