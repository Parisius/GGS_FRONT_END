...
import { useCompleteMovableSafetyStepForm } from "@/lib/safety/movable-safety/hooks/use-complete-movable-safety-step-form";
import DocumentsSectionForm from "@/components/safety/movable-safety/forms/documents-section-form";
export default function CompleteMovableSafetyStepForm({
  formId,
  stepId,
  stepForm,
  className,
  ...
  const { form, filesArray } = useCompleteMovableSafetyStepForm(
    stepForm.fields,
  );
