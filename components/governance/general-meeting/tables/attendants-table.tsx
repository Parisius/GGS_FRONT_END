...
import { useAllMeetingAttendants } from "@/services/api-sdk/models/general-meeting";
import AllAttendantsCheckbox from "@/components/governance/general-meeting/buttons/all-attendants-checkbox";
import AttendantCheckbox from "@/components/governance/general-meeting/buttons/attendant-checkbox";
import {
...
export const getColumns = (meetingId) => [
  ...
  },
  {
    id: "actions",
    cell: ({ row }) =>
      row.original.type === "not_shareholder" && (
