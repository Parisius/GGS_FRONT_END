...
import { usePrintSteeringCommitteeChecklist } from "@/services/api-sdk/models/steering-committee";
...
export default function PrintChecklistButton({
  ...
  const form = useForm();
  const { mutateAsync } = usePrintSteeringCommitteeChecklist(meetingId);
