...
import ProcedureTable from "@/components/governance/steering-committee/tables/procedure-table";
import PrintProceduresButton from "@/components/governance/steering-committee/buttons/print-procedures-button";
