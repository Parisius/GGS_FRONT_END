...
import { usePrintAdministrationMeeting } from "@/services/api-sdk/models/administration-meeting";
export default function PrintAdministrationMeetingButton({
  meetingId,
  className,
  ...props
}) {
  const form = useForm();
  const { mutateAsync } = usePrintAdministrationMeeting(meetingId);
