...
import { useAllMeetingAttendants } from "@/services/api-sdk/models/steering-committee";
import AllAttendantsCheckbox from "@/components/governance/steering-committee/buttons/all-attendants-checkbox";
import AttendantCheckbox from "@/components/governance/steering-committee/buttons/attendant-checkbox";
import {
  UpdateAttendantDialog,
  UpdateAttendantDialogErrorBoundary,
} from "@/components/governance/steering-committee/modals/update-attendant-dialog";
import DeleteAttendantButton from "@/components/governance/steering-committee/buttons/delete-attendant-button";
import AddAttendantDialog from "@/components/governance/steering-committee/modals/add-attendant-dialog";
export const getColumns = (meetingId) => [
  ...
  },
  {
    id: "actions",
    cell: ({ row }) =>
      row.original.type === "not_administrator" && (
