...
import { usePrintMortgage } from "@/services/api-sdk/models/mortgage/mortgage";
import { saveAs } from "file-saver";
import { cn } from "@/lib/utils";
export default function PrintMortgageButton({
  mortgageId,
  className,
  ...props
}) {
  const form = useForm();
  const { mutateAsync } = usePrintMortgage(mortgageId);
