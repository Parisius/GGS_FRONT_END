...
import { usePrintMovableSafety } from "@/services/api-sdk/models/movable-safety";
export default function PrintMovableSafetyButton({
  movableSafetyId,
  className,
  ...props
}) {
  const form = useForm();
  const { mutateAsync } = usePrintMovableSafety(movableSafetyId);
