...
import { usePrintAdministrationMeetingChecklist } from "@/services/api-sdk/models/administration-meeting";
...
export default function PrintChecklistButton({
  ...
  const form = useForm();
  const { mutateAsync } = usePrintAdministrationMeetingChecklist(meetingId);
