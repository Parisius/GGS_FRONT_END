...
import { usePrintJudicialItem } from "@/services/api-sdk/models/legal-monitoring/judicial-item";
export default function PrintJudicialItemButton({
  itemId,
  className,
  ...props
}) {
  const form = useForm();
  const { mutateAsync } = usePrintJudicialItem(itemId);
