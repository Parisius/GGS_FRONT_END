...
import { formatStatus } from "@/lib/governance/steering-committee";
import Link from "next/link";
import { SteeringCommitteeRoutes } from "@/config/routes";
export default function SteeringCommitteeCard({
  meetingId,
  title,
  reference,
  meetingDate,
      ...
      <CardHeader className="gap-2">
        ...
        <div className="flex items-center justify-between gap-2">
          ...
          >
            <Link
              key={reference}
              href={SteeringCommitteeRoutes.session(meetingId).index}
            >
